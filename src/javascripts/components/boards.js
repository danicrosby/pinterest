  ...
  array.forEach((item) => {
    ...
    <div class="card-body">
     <div class="container board-card-icons">
      ...
      <a href="#"><h4 id="see-pins-for-this-board--${item.firebaseKey}" class="card-title" style="font-size: 1em; font-weight: bold; margin-top: -10px; margin-left: -1em">${item.board_title}</h4></a>
    </div>
  </div>`;
  });
};
